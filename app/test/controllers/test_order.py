...
def test_calculate_order_price(app, ingredients, size, client_data):
    created_size, created_ingredients = __create_sizes_beverages_and_ingredients(ingredients, [size])
...
def test_get_all(app, ingredients, sizes, client_data):
    created_sizes, created_ingredients = __create_sizes_beverages_and_ingredients(ingredients, sizes)
    created_orders = []
    for _ in range(5):
